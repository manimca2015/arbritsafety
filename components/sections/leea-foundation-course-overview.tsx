...
const details = [
  {
    icon: Clock,
    label: "Duration",
    description: "3 Days of intensive training.",
  },
  {
    icon: Award,
    label: "Accreditation",
...
export function LeeaFoundationCourseOverview() {
  return (
    <section className="bg-muted py-20 md:py-28">
      <div className="mx-auto max-w-7xl px-6">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="font-heading text-3xl font-bold text-[#0066b2] sm:text-4xl">
            LEEA Foundation Certificate (FOU)
          </h2>
          <h3 className="mt-4 font-heading text-xl font-bold text-[#000]">Course Overview & Aim</h3>
          <p className="mt-3 text-[#000]">
            To provide participants with a clear understanding of lifting equipment, industry terminology, and
            safe working practices, enabling them to support lifting operations effectively.
          </p>
        </div>
